...
async function main() {
  ...
  if(adminAddress && paymentTokenAddress && approverAddress && sweeperAddress && paymentManagerAddress) {
    ...
    const PaymentPROClonable = await ethers.getContractFactory("PaymentPROClonableV3");
    ...
    const PaymentPROFactory = await ethers.getContractFactory("PaymentPROFactoryV3");
